...
data=read.table(file = "~/Desktop/DATES_figures/data/Figure3_data_map",header = T)
head(data)
world <- ne_countries(scale = "medium", returnclass = "sf")
Europe <- world[which(world$continent == "Europe"),]
# Hunter Gatherer distribution panel
jpeg(file ="~/Desktop/DATES_figures/results/Figure3_map_HG_distribution.jpeg",width = 4,height =4,units="in",res =1000)
...
jpeg(file ="~/Desktop/DATES_figures/results/Figure3_map_ANF_distribution.jpeg",width =4,height = 4,units="in",res =1000)
...
jpeg(file ="~/Desktop/DATES_figures/results/Figure3_map_SP_distribution.jpeg",width = 5,height = 4,units="in",res =1000)
...
jpeg(file ="~/Desktop/DATES_figures/results/Figure3_map_HG_AdmixtureDates.jpeg",width = 16,height = 7,units="in",res =1000)
par(mai = c(1,1,0.1,3))
data=read.table(file = "~/Desktop/DATES_figures/data/Figure3_data_admixturetimes")
fossil_range=read.table(file = "~/Desktop/DATES_figures/data/Figure3_data_fossilages",header = F)
...
jpeg(file ="~/Desktop/DATES_figures/results/Figure3_map_ANF_AdmixtureDates.jpeg",width = 16,height = 7,units="in",res =1000)
...
jpeg(file ="~/Desktop/DATES_figures/results/Figure3_map_SP_AdmixtureDates.jpeg",width = 16,height = 7,units="in",res =1000)
